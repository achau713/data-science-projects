...
Convrt date and time columns to Date objects
```{r}
...
# Experiment with Plotly visualizations
```{r}
library(plotly)

# data frame of violation type and street name
df <-  data.frame(muni$violation_type, muni$street_name)
