...
total_missing <-  function(missing_column){
  cat("Total missing values:", sum(is.na(missing_column)), "\n")
}

total_missing(muni$`Amount Due`)
total_missing(muni$`Suspend Code`)
total_missing(muni$`Suspend Process Date`)
total_missing(muni$`Suspend Until Date`)
total_missing(muni$`Disposition Code`)
total_missing(muni$Geom)
