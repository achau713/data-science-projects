...
Also, forecasting is difficult for this data set. The data is collected every 6 months which implies forecasted estimates for Big Mac prices every 6 months. This is an unreasonable assumption of this model which assumes we can precisely forecast 6 months out in advance given the sparsity of our data. 
